...
class LivoxDetectionNode(Node):
    ...
    def __init__(self):
        ...
        # Re-publish the input cloud on /livox/mid360/points (real-robot bridge
        # behaviour). Must be false in sim, where that topic is the simulator's own.
        self.declare_parameter("republish_cloud", True)
        # RELIABLE input in sim (large fragmented clouds, see lidar_bridge).
